...
public class FanVendorView {
	...
	private void style(FanVendorVar var) {
		...
		var.VendorTable.setMaxWidth(600);
		
		var.ItemTable.setMaxHeight(150);
		var.ItemTable.setMaxWidth(500);

		var.id_col.setPrefWidth(50);
		var.username_col.setPrefWidth(225);
		var.email_col.setPrefWidth(225);
		var.action_col.setPrefWidth(100);

		var.itemId_col.setPrefWidth(50);
		var.itemName_col.setPrefWidth(350);
		var.itemAction_col.setPrefWidth(100);
